...
// Explicit visit flags replacing removed read-count shorthand.
VAR visited_admit_open_to_pressure: bool = false
VAR visited_admitted_to_something: bool = false
VAR visited_admitted_to_something_i_know_where: bool = false
VAR visited_admitted_to_something_ive_done_things: bool = false
VAR visited_admitted_to_something_say_nothing: bool = false
VAR visited_all_too_farfetched: bool = false
VAR visited_alone: bool = false
VAR visited_an_accident: bool = false
VAR visited_back_of_hut_2: bool = false
VAR visited_bunk_opts: bool = false
VAR visited_cant_talk_right: bool = false
VAR visited_check: bool = false
VAR visited_claim_hooper_took_component: bool = false
VAR visited_claim_hooper_took_component_go_in_alone: bool = false
VAR visited_claim_hooper_took_component_go_in_alone_yes: bool = false
VAR visited_claim_hooper_took_component_harris_being_convinced: bool = false
VAR visited_claim_hooper_took_component_harrumphs: bool = false
VAR visited_claim_hooper_took_component_hoopers_hut_3: bool = false
VAR visited_claim_hooper_took_component_its_your_problem: bool = false
VAR visited_claim_hooper_took_component_putmein: bool = false
VAR visited_claim_hooper_took_component_shake_head: bool = false
VAR visited_claim_hooper_took_component_we_wont_guess: bool = false
VAR visited_claim_hooper_took_component_yes: bool = false
VAR visited_cooperate: bool = false
VAR visited_delay: bool = false
VAR visited_deny: bool = false
VAR visited_devil: bool = false
VAR visited_didnt_have_long: bool = false
VAR visited_disagree: bool = false
VAR visited_done: bool = false
VAR visited_drinkfromcup: bool = false
VAR visited_drinkit: bool = false
VAR visited_droll: bool = false
VAR visited_ending_return_to_normal: bool = false
VAR visited_ending_return_to_normal_moreimportant: bool = false
VAR visited_find_something_to_smash_window: bool = false
VAR visited_fine: bool = false
VAR visited_found_missing_component: bool = false
VAR visited_from_outside_heard: bool = false
VAR visited_glad_youre_here: bool = false
VAR visited_go_in_alone: bool = false
VAR visited_go_to_hoopers_dorm: bool = false
VAR visited_go_to_hoopers_dorm_outer_zip: bool = false
VAR visited_go_to_hoopers_dorm_put_component_on_tent: bool = false
VAR visited_go_to_hoopers_dorm_toss_component_into_bushes: bool = false
VAR visited_go_to_hoopers_dorm_wide_circuit: bool = false
VAR visited_go_to_where_component_is_hidden: bool = false
VAR visited_go_to_where_component_is_hidden_check: bool = false
VAR visited_go_to_where_component_is_hidden_done: bool = false
VAR visited_harris_asks_for_theory: bool = false
VAR visited_harris_asks_for_theory_an_accident: bool = false
VAR visited_harris_being_convinced: bool = false
VAR visited_harris_believes: bool = false
VAR visited_harris_certain_is_you: bool = false
VAR visited_harris_demands_component: bool = false
VAR visited_harris_demands_component_cant_talk_right: bool = false
VAR visited_harris_demands_component_drinkfromcup: bool = false
VAR visited_harris_demands_component_drinkit: bool = false
VAR visited_harris_demands_component_nope: bool = false
VAR visited_harris_demands_component_nothing: bool = false
VAR visited_harris_demands_component_nothing_ashamed_of: bool = false
VAR visited_harris_demands_component_silence: bool = false
VAR visited_harris_demands_component_suppose_i_have: bool = false
VAR visited_harris_demands_component_whatsinit: bool = false
VAR visited_harris_demands_you_speak: bool = false
VAR visited_harris_has_seen_it_before: bool = false
VAR visited_harris_has_seen_it_before_tell_me_now: bool = false
VAR visited_harris_presses_for_details: bool = false
VAR visited_harris_presses_for_details_admit_open_to_pressure: bool = false
VAR visited_harris_takes_you_to_hooper: bool = false
VAR visited_harris_takes_you_to_hooper_only_catch: bool = false
VAR visited_harris_takes_you_to_hooper_shouted: bool = false
VAR visited_harris_threatens_lynching: bool = false
VAR visited_harris_threatens_lynching_too_clever: bool = false
VAR visited_harrumphs: bool = false
VAR visited_head_for_my_dorm_free: bool = false
VAR visited_head_for_my_dorm_free_quince: bool = false
VAR visited_here_at_bletchley_diversion: bool = false
VAR visited_here_at_bletchley_diversion_fine: bool = false
VAR visited_here_at_bletchley_diversion_iamnotraitor: bool = false
VAR visited_here_at_bletchley_diversion_sore: bool = false
VAR visited_here_at_bletchley_diversion_suggest_its_a_lie: bool = false
VAR visited_hooper_didnt_give_himself_up: bool = false
VAR visited_hoopers_hut_3: bool = false
VAR visited_hustled_out: bool = false
VAR visited_i_dont_have_it: bool = false
VAR visited_i_know_where: bool = false
VAR visited_i_met_a_young_man: bool = false
VAR visited_i_met_a_young_man_didnt_have_long: bool = false
VAR visited_i_met_a_young_man_i_dont_have_it: bool = false
VAR visited_i_met_a_young_man_nope: bool = false
VAR visited_i_met_a_young_man_nope_didnt_hide: bool = false
VAR visited_i_met_a_young_man_notright: bool = false
VAR visited_i_met_a_young_man_passed_onto_hooper: bool = false
VAR visited_i_met_a_young_man_paused: bool = false
VAR visited_i_met_a_young_man_still_have: bool = false
VAR visited_i_met_a_young_man_yes: bool = false
VAR visited_iamnotraitor: bool = false
VAR visited_inside_hoopers_hut: bool = false
VAR visited_inside_hoopers_hut_back_of_hut_2: bool = false
VAR visited_inside_hoopers_hut_hustled_out: bool = false
VAR visited_inside_hoopers_hut_lie: bool = false
VAR visited_inside_hoopers_hut_no_chance: bool = false
VAR visited_its_your_problem: bool = false
VAR visited_ive_done_things: bool = false
VAR visited_left_alone: bool = false
VAR visited_lie: bool = false
VAR visited_lift_up_cup: bool = false
VAR visited_listened: bool = false
VAR visited_live_on_the_run: bool = false
VAR visited_make_your_peace: bool = false
VAR visited_make_your_peace_monastic: bool = false
VAR visited_missing_reel: bool = false
VAR visited_monastic: bool = false
VAR visited_moreimportant: bool = false
VAR visited_morning_not_saved: bool = false
VAR visited_my_lips_are_sealed: bool = false
VAR visited_night_falls: bool = false
VAR visited_night_falls_hooper_didnt_give_himself_up: bool = false
VAR visited_night_falls_morning_not_saved: bool = false
VAR visited_night_falls_morning_not_saved_optimism: bool = false
VAR visited_night_falls_morning_not_saved_pessimism: bool = false
VAR visited_night_falls_optimism: bool = false
VAR visited_night_falls_pessimism: bool = false
VAR visited_night_passes: bool = false
VAR visited_night_passes_deny: bool = false
VAR visited_night_passes_devil: bool = false
VAR visited_night_passes_droll: bool = false
VAR visited_night_passes_found_missing_component: bool = false
VAR visited_night_passes_found_missing_component_devil: bool = false
VAR visited_night_passes_glad_youre_here: bool = false
VAR visited_night_passes_not_that: bool = false
VAR visited_night_passes_put_component_inside_tent: bool = false
VAR visited_night_passes_put_component_inside_tent_droll: bool = false
VAR visited_night_passes_put_component_inside_tent_not_that: bool = false
VAR visited_night_passes_someone_threw_component: bool = false
VAR visited_no: bool = false
VAR visited_no_chance: bool = false
VAR visited_nope: bool = false
VAR visited_nope_didnt_hide: bool = false
VAR visited_not_that: bool = false
VAR visited_nothing: bool = false
VAR visited_nothing_ashamed_of: bool = false
VAR visited_notright: bool = false
VAR visited_only_catch: bool = false
VAR visited_optimism: bool = false
VAR visited_opts: bool = false
VAR visited_outer_zip: bool = false
VAR visited_passed_onto_hooper: bool = false
VAR visited_pause: bool = false
VAR visited_paused: bool = false
VAR visited_pessimism: bool = false
VAR visited_plan: bool = false
VAR visited_pushes_cup: bool = false
VAR visited_put_component_inside_tent: bool = false
VAR visited_put_component_on_tent: bool = false
VAR visited_putmein: bool = false
VAR visited_quince: bool = false
VAR visited_return_to_room_after_excursion: bool = false
VAR visited_reveal_location_of_component: bool = false
VAR visited_reveal_location_of_component_harris_believes: bool = false
VAR visited_say_nothing: bool = false
VAR visited_shake_head: bool = false
VAR visited_shouted: bool = false
VAR visited_silence: bool = false
VAR visited_slam_door_shut_and_gone: bool = false
VAR visited_slam_door_shut_and_gone_alone: bool = false
VAR visited_slam_door_shut_and_gone_bunk_opts: bool = false
VAR visited_slam_door_shut_and_gone_find_something_to_smash_window: bool = false
VAR visited_slam_door_shut_and_gone_find_something_to_smash_window_bunk_opts: bool = false
VAR visited_slam_door_shut_and_gone_find_something_to_smash_window_opts: bool = false
VAR visited_slam_door_shut_and_gone_from_outside_heard: bool = false
VAR visited_slam_door_shut_and_gone_from_outside_heard_listened: bool = false
VAR visited_slam_door_shut_and_gone_from_outside_heard_opts: bool = false
VAR visited_slam_door_shut_and_gone_listened: bool = false
VAR visited_slam_door_shut_and_gone_opts: bool = false
VAR visited_slam_door_shut_and_gone_pause: bool = false
VAR visited_slam_door_shut_and_gone_time_to_move_now: bool = false
VAR visited_slam_door_shut_and_gone_time_to_move_now_alone: bool = false
VAR visited_slam_door_shut_and_gone_time_to_move_now_pause: bool = false
VAR visited_slam_door_shut_and_gone_try_the_door: bool = false
VAR visited_slam_door_shut_and_gone_try_the_windows: bool = false
VAR visited_slam_door_shut_and_gone_try_to_smash_the_window: bool = false
VAR visited_slam_door_shut_and_gone_try_to_smash_the_window_use_bucket: bool = false
VAR visited_slam_door_shut_and_gone_use_bucket: bool = false
VAR visited_smash_the_window: bool = false
VAR visited_someone_threw_component: bool = false
VAR visited_sore: bool = false
VAR visited_start: bool = false
VAR visited_start_cooperate: bool = false
VAR visited_start_delay: bool = false
VAR visited_start_disagree: bool = false
VAR visited_start_lift_up_cup: bool = false
VAR visited_start_no: bool = false
VAR visited_start_opts: bool = false
VAR visited_start_plan: bool = false
VAR visited_start_pushes_cup: bool = false
VAR visited_start_tellme: bool = false
VAR visited_start_think: bool = false
VAR visited_start_took: bool = false
VAR visited_start_waited: bool = false
VAR visited_start_waited_disagree: bool = false
VAR visited_start_waited_lift_up_cup: bool = false
VAR visited_start_waited_no: bool = false
VAR visited_start_waited_pushes_cup: bool = false
VAR visited_start_waited_tellme: bool = false
VAR visited_start_waited_took: bool = false
VAR visited_start_waited_what2: bool = false
VAR visited_start_what2: bool = false
VAR visited_still_have: bool = false
VAR visited_suggest_its_a_lie: bool = false
VAR visited_suppose_i_have: bool = false
VAR visited_tell_me_now: bool = false
VAR visited_tellme: bool = false
VAR visited_think: bool = false
VAR visited_time_to_move_now: bool = false
VAR visited_too_clever: bool = false
VAR visited_took: bool = false
VAR visited_toss_component_into_bushes: bool = false
VAR visited_try_the_door: bool = false
VAR visited_try_the_windows: bool = false
VAR visited_try_to_smash_the_window: bool = false
VAR visited_use_bucket: bool = false
VAR visited_waited: bool = false
VAR visited_we_wont_guess: bool = false
VAR visited_what2: bool = false
VAR visited_whatsinit: bool = false
VAR visited_wide_circuit: bool = false
VAR visited_yes: bool = false
...
//  Intro
	...
	- (opts)
		~ visited_opts = true
		~ visited_start_opts = true
		{|I rattle my fingers on the field table.|}
 		* 	(think) Think 
 			~ visited_think = true
 			~ visited_start_think = true
			...
			When they don't find it, {visited_plan:then} they'll come back and demand I talk. 
			-> opts
 		*	(plan) Plan
 			~ visited_plan = true
 			~ visited_start_plan = true
 			{not visited_think:What I am is|I am} a problem—solver. Good with figures, quick with crosswords, excellent at chess. 
 			But in this scenario — in this trap — what is the winning play?
 			* * 	(cooperate) Co—operate 
 				~ visited_cooperate = true
 				~ visited_start_cooperate = true
...
= waited 
	...
	-	Half an hour goes by before Commander Harris returns. He closes the door behind him quickly, as though afraid a loose word might slip inside.
		...
		*	"Commander."
			He nods. <>
		*	(tellme) {not visited_start_delay} "Tell me what this is about."
			~ visited_tellme = true
			~ visited_start_tellme = true
			~ visited_start_waited_tellme = true
			He shakes his head. 
			"Now, don't let's pretend."
		*	Wait
			I say nothing.
	-	He has brought two cups of tea in metal mugs: he sets them down on the tabletop between us.
		*	{visited_tellme} Deny "I'm not pretending anything."
			{visited_cooperate:I'm lying already, despite my good intentions.}
			Harris looks disapproving. -> pushes_cup
		*	(took) Take one
			~ visited_took = true
			~ visited_start_took = true
			~ visited_start_waited_took = true
			~ teacup = true
			I take a mug and warm my hands. It's <>
		*	(what2) {not visited_tellme} "What's going on?"
			~ visited_what2 = true
			~ visited_start_what2 = true
			~ visited_start_waited_what2 = true
			"You know already."
			-> pushes_cup
		*	Wait
			I wait for him to speak. 
			- - (pushes_cup) He pushes one mug halfway towards me: <>
				~ visited_pushes_cup = true
				~ visited_start_pushes_cup = true
				~ visited_start_waited_pushes_cup = true
	-	a small gesture of friendship. 
		Enough to give me hope?
 		* 	(lift_up_cup) {not teacup} Take it 
 			~ visited_lift_up_cup = true
 			~ visited_start_lift_up_cup = true
 			~ visited_start_waited_lift_up_cup = true
 				I {visited_took:lift the mug|take the mug,} and blow away the steam. It is too hot to drink. 
...
- 	"Quite a difficult situation," {visited_lift_up_cup:he|Harris} begins{forceful <= 0:, sternly}. I've seen him adopt this stiff tone of voice before, but only when talking to the brass. "I'm sure you agree."
 		* 	Agree 
 				"Awkward," I reply
 		* 	(disagree) Disagree 
 			~ visited_disagree = true
 			~ visited_start_disagree = true
 			~ visited_start_waited_disagree = true
...
// Why you're here
	...
	-	
 		...
 		* (no) No
 			~ visited_no = true
 			~ visited_start_no = true
 			~ visited_start_waited_no = true
...
== here_at_bletchley_diversion ==
	~ visited_here_at_bletchley_diversion = true
 	...
 	* (fine) "I'm fine."," I reply. "This is all some misunderstanding and the quicker we have it cleared up the better."
 		~ visited_fine = true
 		~ visited_here_at_bletchley_diversion_fine = true
 		~ lower(forceful)
	...
	*	{forceful < 0}	"What do you mean by that?"
 	...
 	* (sore) { forceful >= 0 } "Damn right." I'm sore. Was it one of the others who put you up to this? Was it Hooper? He's always been jealous of me. He's..."
 		~ visited_sore = true
 		~ visited_here_at_bletchley_diversion_sore = true
 		~ raise(forceful)
 		...
 		* * 	"Of my genius." Hooper simply can't stand that I'm cleverer than he is. We work so closely together, cooped up in that Hut all day. It drives him to distraction. To worse."
				"You're suggesting Hooper would sabotage this country's future simply to spite you?" Harris chooses his words like the military man he is, each lining up to create a ring around me.
					...
					- - - 	(suggest_its_a_lie) "All I can say is, ever since I arrived here, he's been looking to ways to bring me down a peg. I wouldn't be surprised if he set this whole affair up just to have me court—martialled."
						~ visited_suggest_its_a_lie = true
						~ visited_here_at_bletchley_diversion_suggest_its_a_lie = true
 					...
 					* * * 	(iamnotraitor) "I'm no traitor."," I answer{forceful > 0 :smartly|, voice quivering. "For God's sake!"}
 						~ visited_iamnotraitor = true
 						~ visited_here_at_bletchley_diversion_iamnotraitor = true
 					* * * 	Lie -> iamnotraitor
...
== harris_demands_component ==
	~ visited_harris_demands_component = true
	"{visited_here_at_bletchley_diversion:Please|So}. Do you have it?" Harris is {forceful > 3:sweating slightly|wasting no time}: Bletchley is his watch. "Do you know where it is?"
	 	* 	Yes
	 		"I do." 
	 		-> admitted_to_something
	 	* (nope) No "I have no idea." 
	 		~ visited_nope = true
	 		~ visited_harris_demands_component_nope = true
	 					-> silence
	 	* Lie 		-> nope
	 	* Evade 		
	 		"The component?"
			 ~ raise(evasive)
			 ~ lower(forceful)
			"Don't play stupid," he replies. "{ not visited_missing_reel:The component that went missing this afternoon. }Where is it?"
	...
	- 	{ not visited_missing_reel:
 		...
 		* (nothing) Delay "I know nothing about it." My voice shakes{ forceful > 0:  with anger|; I'm unaccustomed to facing off against men with holstered guns}. 
 			~ visited_nothing = true
 			~ visited_harris_demands_component_nothing = true
		...
		-	(silence) There's an icy silence. { forceful > 2:I've cracked him a little.|{ evasive > 2:He's tiring of my evasiveness.}} 
			~ visited_silence = true
			~ visited_harris_demands_component_silence = true

		// Drink tea and talk
		- (drinkit) "Now drink your tea and talk."
			~ visited_drinkit = true
			~ visited_harris_demands_component_drinkit = true
		 ...
		 * { not teacup  }  Take the cup 
		 		- - (drinkfromcup) I lift the cup { teacup :to my lips }and sip. He waits for me to swallow before speaking again.
		 			~ visited_drinkfromcup = true
		 			~ visited_harris_demands_component_drinkfromcup = true
			 		~ drugged  = true
			 		~ teacup    = true
		 * { not teacup  }  Don't take it 
				...
				- - (whatsinit) "Why?" I ask coldly. "What's in it?"
					~ visited_whatsinit = true
					~ visited_harris_demands_component_whatsinit = true
				
	- 	"Lapsang Souchong," he {visited_drinkfromcup:remarks|replies}, placing his own cup back on the table untouched. "Such a curious flavour. It might almost not be tea at all. You might say it hides a multitude of sins. As do you. Isn't that right?"
 
		 * (suppose_i_have) Agree 
		 	~ visited_suppose_i_have = true
		 	~ visited_harris_demands_component_suppose_i_have = true
			 	// Regrets
		...
		* (nothing_ashamed_of) { not drugged  }   Disagree
			~ visited_nothing_ashamed_of = true
			~ visited_harris_demands_component_nothing_ashamed_of = true
		 		"I've done nothing that I'm ashamed of."
 				-> harris_asks_for_theory

		 * (cant_talk_right) { drugged  }   Disagree 
		 	~ visited_cant_talk_right = true
		 	~ visited_harris_demands_component_cant_talk_right = true
...
== harris_presses_for_details ==
	~ visited_harris_presses_for_details = true
// Open to Blackmail
...
= admit_open_to_pressure
	~ visited_admit_open_to_pressure = true
	~ visited_harris_presses_for_details_admit_open_to_pressure = true
...
== admitted_to_something ==
	~ visited_admitted_to_something = true
	// Admitting Something
	{ not drugged  :
	...
	"You want to explain that?"
		 ...
		 * (say_nothing) { drugged  }   Say nothing
		 	~ visited_say_nothing = true
		 	~ visited_admitted_to_something_say_nothing = true
...
= i_know_where
	~ visited_i_know_where = true
	~ visited_admitted_to_something_i_know_where = true
...
= ive_done_things
	~ visited_ive_done_things = true
	~ visited_admitted_to_something_ive_done_things = true
	 "I've done things," I begin{visited_harris_demands_component_cant_talk_right: helplessly}. "Things I didn't want to do. I tried not to. But in the end, it felt like cutting off my own arm to resist."
	-> harris_presses_for_details
...
== harris_asks_for_theory ==
	~ visited_harris_asks_for_theory = true
...
= an_accident
	~ visited_an_accident = true
	~ visited_harris_asks_for_theory_an_accident = true
...
== harris_has_seen_it_before ==
	~ visited_harris_has_seen_it_before = true
...
- 	(tell_me_now) <> So why don't you tell me, right now. Where is it?"
	~ visited_tell_me_now = true
	~ visited_harris_has_seen_it_before_tell_me_now = true
	-> harris_demands_you_speak
...
== harris_demands_you_speak ==
	~ visited_harris_demands_you_speak = true
...
== i_met_a_young_man ==
	~ visited_i_met_a_young_man = true
	//  Explain Story
	*	Talk
...
- 	He seemed to know all about me. He... he was quite enchanted by my achievements."
	 ...
	 * (nope) { not drugged  }  No "The boy was a pretty simpleton. Quite inferior. His good opinion meant nothing to be. Harris, do not misunderstand. I was simply after his body."
	 	~ visited_nope = true
	 	~ visited_i_met_a_young_man_nope = true
			 ~ raise(evasive)
...
- (paused) 
	~ visited_paused = true
	~ visited_i_met_a_young_man_paused = true
	 { not visited_nope:
	 ...
	 * (yes) Yes 
	 	~ visited_yes = true
	 	~ visited_i_met_a_young_man_yes = true
		...
		* * (still_have)	I have it 	
			~ visited_still_have = true
			~ visited_i_met_a_young_man_still_have = true
	 ...
	 * (notright) No 
	 	~ visited_notright = true
	 	~ visited_i_met_a_young_man_notright = true
		...
		* * (didnt_have_long) Yes 
			~ visited_didnt_have_long = true
			~ visited_i_met_a_young_man_didnt_have_long = true
		...
		* * Evade 		
			...
			* * * Yes -> didnt_have_long
			* * * (nope_didnt_hide) No 
				~ visited_nope_didnt_hide = true
				~ visited_i_met_a_young_man_nope_didnt_hide = true
...
= i_dont_have_it
	~ visited_i_dont_have_it = true
	~ visited_i_met_a_young_man_i_dont_have_it = true
...
= passed_onto_hooper
	~ visited_passed_onto_hooper = true
	~ visited_i_met_a_young_man_passed_onto_hooper = true
	~ hooper_mentioned = true
...
== claim_hooper_took_component ==
	~ visited_claim_hooper_took_component = true
//  Blame Hooper
	...
	- (hoopers_hut_3) "Hooper's in Hut 3 with the Captain, having a similar conversation."
		~ visited_hoopers_hut_3 = true
		~ visited_claim_hooper_took_component_hoopers_hut_3 = true
	...
	- (we_wont_guess) <> We're not in the business of guessing here at Bletchley. We are military intelligence. We get answers." Harris points a finger. "And if that component has left these grounds, then every minute is critical."
		~ visited_we_wont_guess = true
		~ visited_claim_hooper_took_component_we_wont_guess = true
	 * Co-operate 
...
= harris_being_convinced
	~ visited_harris_being_convinced = true
	~ visited_claim_hooper_took_component_harris_being_convinced = true
...
= putmein
	~ visited_putmein = true
	~ visited_claim_hooper_took_component_putmein = true
...
= shake_head
	~ visited_shake_head = true
	~ visited_claim_hooper_took_component_shake_head = true
	// Can't help
...
= its_your_problem
	~ visited_its_your_problem = true
	~ visited_claim_hooper_took_component_its_your_problem = true
// Won't Help
...
= harrumphs
	~ visited_harrumphs = true
	~ visited_claim_hooper_took_component_harrumphs = true
	Harris harrumphs. He's thinking it all over.
 	* { visited_putmein  }   	Wait 
...
= go_in_alone
	~ visited_go_in_alone = true
	~ visited_claim_hooper_took_component_go_in_alone = true
	"Alone?"
	"Alone."
	...
	* 	Impatient "For God's sake, man, what do you have to lose?" 
 	...
 	* (yes) Yes
 		~ visited_yes = true
 		~ visited_claim_hooper_took_component_yes = true
 		~ visited_claim_hooper_took_component_go_in_alone_yes = true
 			"Absolutely."
 	* 	No
 			"No."
			"Too bad." 
...
== harris_takes_you_to_hooper ==
	~ visited_harris_takes_you_to_hooper = true
	// Past Hooper
	...
	Then, he smiles, with all his teeth, like a wolf. 
	 { visited_claim_hooper_took_component_hoopers_hut_3:
	 ...
	 * 	(shouted) Call to Hooper 
	 	~ visited_shouted = true
	 	~ visited_harris_takes_you_to_hooper_shouted = true
		...
		"I'll get you Hooper, you'll see!" I cry. Then:
			...
			- - (only_catch) I only catch Hooper's reaction for a moment — his eyebrow lifts in surprise and alarm. Good. If he thinks it is a threat then he just might be careless enough to go looking for what it might mean.
				~ visited_only_catch = true
				~ visited_harris_takes_you_to_hooper_only_catch = true
...
== inside_hoopers_hut ==
	~ visited_inside_hoopers_hut = true
	 ...
	 * Bargain 
		 ...
		 * * 	(lie) Lie 
		 	~ visited_lie = true
		 	~ visited_inside_hoopers_hut_lie = true
...
= back_of_hut_2
	~ visited_back_of_hut_2 = true
	~ visited_inside_hoopers_hut_back_of_hut_2 = true
...
= no_chance
	~ visited_no_chance = true
	~ visited_inside_hoopers_hut_no_chance = true
...
= hustled_out
	~ visited_hustled_out = true
	~ visited_inside_hoopers_hut_hustled_out = true
	// To Barracks
...
== slam_door_shut_and_gone ==
	~ visited_slam_door_shut_and_gone = true
...
= try_the_door
	~ visited_try_the_door = true
	~ visited_slam_door_shut_and_gone_try_the_door = true
	I try the door. It's locked, of course. 
	 -> from_outside_heard

= from_outside_heard
	~ visited_from_outside_heard = true
	~ visited_slam_door_shut_and_gone_from_outside_heard = true
	From outside, I hear a voice. Hooper's. He's haranguing someone.
	- (opts)
		~ visited_opts = true
		~ visited_slam_door_shut_and_gone_opts = true
		~ visited_slam_door_shut_and_gone_from_outside_heard_opts = true
	*  (listened) Listen at the keyhole 
		~ visited_listened = true
		~ visited_slam_door_shut_and_gone_listened = true
		~ visited_slam_door_shut_and_gone_from_outside_heard_listened = true
	...
	* { not visited_try_the_windows  }   Try the window -> try_the_windows
	* { not visited_try_the_door  } {visited_listened}   Try the door -> try_the_door
	* { visited_try_the_windows  }   Smash the window -> try_to_smash_the_window
	* { visited_try_the_door  && visited_try_the_windows  }   Wait 
	 		It's useless. There's nothing I can do but hope. I sit down on one corner of the bunk to wait.
 			-> night_falls

= try_the_windows
	~ visited_try_the_windows = true
	~ visited_slam_door_shut_and_gone_try_the_windows = true
...
= try_to_smash_the_window
	~ visited_try_to_smash_the_window = true
	~ visited_slam_door_shut_and_gone_try_to_smash_the_window = true
	 ...
	 * (use_bucket) Find something 
	 	~ visited_use_bucket = true
	 	~ visited_slam_door_shut_and_gone_use_bucket = true
	 	~ visited_slam_door_shut_and_gone_try_to_smash_the_window_use_bucket = true
...
= time_to_move_now
	~ visited_time_to_move_now = true
	~ visited_slam_door_shut_and_gone_time_to_move_now = true
	 ...
	 * (pause) Wait a little longer 
	 	~ visited_pause = true
	 	~ visited_slam_door_shut_and_gone_pause = true
	 	~ visited_slam_door_shut_and_gone_time_to_move_now_pause = true
	 ...
	 * Clear the frame of shards
	 ...
	 -	"Be quiet, man. We know all about your and your sordid affairs." The Captain curls his lip. "Don't you know there's a war on? Do you know the kind of place they would have sent you if it haven't had been for that brain of yours? Don't you think you owe it to your country to use it a little more?"
		 ...
		 * 	(alone) No 
		 	~ visited_alone = true
		 	~ visited_slam_door_shut_and_gone_alone = true
		 	~ visited_slam_door_shut_and_gone_time_to_move_now_alone = true
...
= find_something_to_smash_window
	~ visited_find_something_to_smash_window = true
	~ visited_slam_door_shut_and_gone_find_something_to_smash_window = true
	...
	- (opts)
		~ visited_opts = true
		~ visited_slam_door_shut_and_gone_opts = true
		~ visited_slam_door_shut_and_gone_find_something_to_smash_window_opts = true
	*   The bunk 	
		The bunk has a solid metal frame, a blanket, a pillow, nothing more.
		- - (bunk_opts)
			~ visited_bunk_opts = true
			~ visited_slam_door_shut_and_gone_bunk_opts = true
			~ visited_slam_door_shut_and_gone_find_something_to_smash_window_bunk_opts = true
		* *  The frame
		...
		* * {visited_bunk_opts} Something else -> opts
	...
	-  Where now?
 		...
 		* 	Escape the compound 
			...
			* * Don't go 
					...
					* * * 	Back to the barracks 			-> return_to_room_after_excursion
						* * * 	{ gotcomponent   && not visited_go_to_hoopers_dorm  }  To Hooper's dorm -> go_to_hoopers_dorm
...
== go_to_hoopers_dorm ==
	~ visited_go_to_hoopers_dorm = true
	// Hooper's Dorm
	 ...
	 * (outer_zip) Open the outer zip 
	 	~ visited_outer_zip = true
	 	~ visited_go_to_hoopers_dorm_outer_zip = true
	 ...
	 * (wide_circuit) Look for another opening 
	 	~ visited_wide_circuit = true
	 	~ visited_go_to_hoopers_dorm_wide_circuit = true
...
= put_component_on_tent
	~ visited_put_component_on_tent = true
	~ visited_go_to_hoopers_dorm_put_component_on_tent = true
...
= toss_component_into_bushes
	~ visited_toss_component_into_bushes = true
	~ visited_go_to_hoopers_dorm_toss_component_into_bushes = true
...
== return_to_room_after_excursion ==
	~ visited_return_to_room_after_excursion = true
...
// In room smashed glass
	...
	* (deny) Deny 
		~ visited_deny = true
		~ visited_night_passes_deny = true
...
= put_component_inside_tent
	~ visited_put_component_inside_tent = true
	~ visited_night_passes_put_component_inside_tent = true
	 ...
	 * Disagree
	 	...
	 	- - (droll)	"Very droll," he replies. "Let me tell you what happened this morning. It will take the smile off your face. <>
	 		~ visited_droll = true
	 		~ visited_night_passes_droll = true
	 		~ visited_night_passes_put_component_inside_tent_droll = true
	 ...
	 * Be interested 
	 	...
	 	- - (not_that) "No," Harris replies. "That isn't really what I mean. <>
	 		~ visited_not_that = true
	 		~ visited_night_passes_not_that = true
	 		~ visited_night_passes_put_component_inside_tent_not_that = true
...
= someone_threw_component
	~ visited_someone_threw_component = true
	~ visited_night_passes_someone_threw_component = true
...
= glad_youre_here
	~ visited_glad_youre_here = true
	~ visited_night_passes_glad_youre_here = true
...
= found_missing_component
	~ visited_found_missing_component = true
	~ visited_night_passes_found_missing_component = true
	// Framed Hooper
	 ...
	 * (devil) Approve
	 	~ visited_devil = true
	 	~ visited_night_passes_devil = true
	 	~ visited_night_passes_found_missing_component_devil = true
	 ...
	 * Disapprove 
 	...
 	- 	Harris rolls his eyes, but he might almost be smiling. "You'd better get along, { visited_devil :and work through your devils|Mr Intelligent}. There's a 24—hour—late message to be tackled and we're a genius short. So you'd better be ready to work twice as hard."
 		* 	Thank him 	
...
//  Night falls
	...
	* 	Look of out the window 
			I peer out of the window, but it looks out onto the little brook at the back of the compound, with no view of the other huts or the House. Who knows if there are men up, searching the base of Hut 2, following one another with flashlights...
			 {visited_inside_hoopers_hut_back_of_hut_2:
 	...
 	* 	{ hooperClueType > NONE  }   	Wait 
		...
		* * 	Be cautious 
		...
		- -		(hooper_didnt_give_himself_up) There's still the issue of the component. It hasn't turned up. He didn't lead us to it. I guess he figured you must have had something on him. I don't know."
			~ visited_hooper_didnt_give_himself_up = true
			~ visited_night_falls_hooper_didnt_give_himself_up = true
...
= morning_not_saved
	~ visited_morning_not_saved = true
	~ visited_night_falls_morning_not_saved = true
	// Not saved
	...
	* 	(optimism) Be optimistic 
		~ visited_optimism = true
		~ visited_night_falls_optimism = true
		~ visited_night_falls_morning_not_saved_optimism = true
	 	"I'm looking forward to a long bath," I reply. "And getting back to work."
	* 	(pessimism) Be pessimistic 
		~ visited_pessimism = true
		~ visited_night_falls_pessimism = true
		~ visited_night_falls_morning_not_saved_pessimism = true
...
== harris_certain_is_you ==
	~ visited_harris_certain_is_you = true
...
== head_for_my_dorm_free ==
	~ visited_head_for_my_dorm_free = true
 ...
 * Yes 
	...
	- - (quince) "Quince was saying this morning, apparently his grandfather was German. So perhaps it's to be expected. See you there?"
		~ visited_quince = true
		~ visited_head_for_my_dorm_free_quince = true
...
- I wave to him and move away, my thoughts turning to the young man in the village. My lover. My contact. My blackmailer. Hooper may have taken the fall for the missing component, but { not framedhooper :if he did recover it from Hut 2 then | its recovery does mean }I have nothing to sell to save my reputation{ visited_i_met_a_young_man :, if I have any left}. 
 { not framedhooper  :
...
== ending_return_to_normal ==
	~ visited_ending_return_to_normal = true
Nothing, that is, except to act as if there is no game being played. I'll have a bath, then start work as normal. I've got a week to find something to give my blackmailer{ visited_i_met_a_young_man : — or give him nothing: it seems my superiors know about my indiscretions now already}. 
 * Co-operate 
 ...
 * (moreimportant) Evade I've more important problems to think about now. There's still yesterday's intercept to be resolved. 
 	~ visited_moreimportant = true
 	~ visited_ending_return_to_normal_moreimportant = true
...
== go_to_where_component_is_hidden ==
	~ visited_go_to_where_component_is_hidden = true
 	...
 	* 	(check) Check 		
 		~ visited_check = true
 		~ visited_go_to_where_component_is_hidden_check = true
...
== harris_threatens_lynching ==
	~ visited_harris_threatens_lynching = true
 	{ visited_harris_certain_is_you:He passes a hand across his eyes with a long look of despair.|He gets to his feet, and gathers his gloves from the table top.}
	 ...
	 * Protest 
		...
		- - (too_clever) "You leave me no choice," Harris snaps back, eyes cold as gun—metal. "You and your damn cyphers. Your damn clever problems. If men like you didn't exist, if we could just all be <i>straight</i> with one another." He gets to his feet and heads for the door. "I fear for the future of this world, with men like you in. Reich or no Reich, Mr Manning, people like you simply <i>complicate</i> matters."
			~ visited_too_clever = true
			~ visited_harris_threatens_lynching_too_clever = true
		 -> left_alone
...
== reveal_location_of_component ==
	~ visited_reveal_location_of_component = true
	...
	-> harris_believes	
= harris_believes
	~ visited_harris_believes = true
	~ visited_reveal_location_of_component_harris_believes = true
 	{ not visited_night_falls_hooper_didnt_give_himself_up  :
...
== my_lips_are_sealed ==
	~ visited_my_lips_are_sealed = true
...
== all_too_farfetched ==
	~ visited_all_too_farfetched = true
	//  Returned Component
...
== left_alone ==
	~ visited_left_alone = true
	//  Alone, about to die
	{ visited_slam_door_shut_and_gone_time_to_move_now :The Commander holds the door for his superior, and follows him out.} Then the door closes. I am alone again, as I have been for most of my short life.
	 -> make_your_peace


== make_your_peace ==
	~ visited_make_your_peace = true
	* Make your peace
	-	I am waiting again. I have no God to make my peace with. I find it difficult to believe in goodness of any kind, in a world such as this. 
 		...
 		{ visited_harris_threatens_lynching_too_clever:
	...
	-	(monastic) A monastic life, with plenty of problems to keep me going. 
		~ visited_monastic = true
		~ visited_make_your_peace_monastic = true
	...
	- 	That is the true secret of the calculating engine, and the source of its power. It is not the components that matter, they are quite repetitive. What matters is how they are wired; the diversity of the patterns and structures they can form. Much like people — it is how they connect that determines our victories and tragedies, and not their genius.
		Which makes me wonder. Should I give { visited_i_met_a_young_man :up my beautiful young man|the young man who put me in this spot} to them as well as myself?
		 * 	Yes 
