...
impl Op {
    pub fn from_format(function: NativeFunction) -> Self {
        match function {
            ...
            NativeFunction::ToStr => Self::ToStr,
            ...
            NativeFunction::ArrayPush => Self::ArrayPush,
            NativeFunction::ArrayInsert => Self::ArrayInsert,
    ...
    pub fn format_function(self) -> NativeFunction {
        match self {
            ...
            Self::ToStr => NativeFunction::ToStr,
            ...
            Self::ArrayPush => NativeFunction::ArrayPush,
            Self::ArrayInsert => NativeFunction::ArrayInsert,
...
mod tests {
    ...
    fn runtime_operation_metadata_matches_format_native_functions() {
        let cases = [
            ...
            (NativeFunction::ArrayPush, Op::ArrayPush),
            (NativeFunction::ArrayInsert, Op::ArrayInsert),
