...
impl NativeFunctionCall {
    ...
    pub(crate) fn call(
        ...
        match self.op {
            ...
            Op::FieldRead => return composite::field_read(&params),
            Op::IndexRead => return composite::index_read(&params),
            Op::FieldWrite => return composite::field_write(&params),
            Op::IndexWrite => return composite::index_write(&params),
            Op::Len => return composite::len(&params),
            Op::ArrayRemove => return composite::array_remove(&params),
            _ => {}
        }
