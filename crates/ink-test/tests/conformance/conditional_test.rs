...
fn stopping_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/stopping.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn cycle_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/cycle.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn once_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/once.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/shuffle.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_stopping() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/shuffle_stopping.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_once() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/shuffle_once.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/multiline.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/multiline-divert.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/conditional/multiline-choice.ink.json");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
