...
fn variable_declaration_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/variable/variable-declaration.ink.json");
...
fn var_calc_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/variable/varcalc.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn var_string_ink_bug_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/variable/varstringinc.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn var_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/variable/var-divert.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
