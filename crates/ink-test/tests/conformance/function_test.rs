...
fn fun_basic_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/func-basic.ink.json");
...
fn fun_none_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/func-none.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn fun_inline_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/func-inline.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn setvar_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/setvar-func.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func1_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/complex-func1.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func2_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/complex-func2.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func3_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/complex-func3.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn rnd() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/function/rnd-func.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
