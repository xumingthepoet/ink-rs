...
fn single_line_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/single-line.ink.json");
...
fn multi_line_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/multi-line.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn strip_empty_lines_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/strip-empty-lines.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_strings_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-strings.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_ints_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-ints.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_floats_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-floats.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_vars_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-vars.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_multi_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-multi.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn param_recurse_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/knot/param-recurse.ink.json");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
