...
fn tags_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/tags/tags.ink.json");
...
fn tags_in_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/tags/tagsInChoice.ink.json");
    let mut story = Story::new(&json_string);
...
fn tags_in_choice_dynamic_content_test() -> Result<(), StoryError> {
    let json_string = common::get_json_string("inkfiles/tags/tagsInChoiceDynamic.ink.json");
    let mut story = Story::new(&json_string);
