...
fn single_choice1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/single-choice.ink");
...
fn suppress_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/suppress-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn mixed_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/mixed-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn varying_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/varying-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn sticky_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/sticky-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn fallback_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/fallback-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn conditional_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/conditional-choice.ink");
    let mut text: Vec<String> = Vec::new();
...
fn label_flow_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/label-flow.ink");
    let mut text: Vec<String> = Vec::new();
...
fn label_scope_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/label-scope.ink");
    let mut text: Vec<String> = Vec::new();
...
fn divert_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/choices/divert-choice.ink");
    let mut text: Vec<String> = Vec::new();
