...
fn iftrue_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/iftrue.ink");
...
fn iffalse_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/iffalse.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/ifelse.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/ifelse-ext.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/ifelse-ext-text1.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text2_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/ifelse-ext-text2.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text3_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/ifelse-ext-text3.ink");
    println!("{}", story.build_string_of_hierarchy());
...
fn cond_text1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/condtext.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn cond_opt1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/condopt.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn stopping_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/stopping.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn cycle_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/cycle.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn once_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/once.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/shuffle.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_stopping() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/shuffle_stopping.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_once() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/shuffle_once.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/multiline.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_divert_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/multiline-divert.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/conditional/multiline-choice.ink");
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
