...
fn fun_basic_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/func-basic.ink");
...
fn fun_none_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/func-none.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn fun_inline_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/func-inline.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn setvar_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/setvar-func.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/complex-func1.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func2_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/complex-func2.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func3_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/complex-func3.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn rnd() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/function/rnd-func.ink");
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn evaluating_function_variable_state_bug_test() -> Result<(), StoryError> {
    let mut story =
        common::compile_story("inkfiles/function/evaluating-function-variablestate-bug.ink");
    ...
    assert_eq!("RIGHT", result.unwrap().unwrap().get::<String>().unwrap());
