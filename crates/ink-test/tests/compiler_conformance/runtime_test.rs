...
use crate::compiler_conformance::api::{
...
fn external_function() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/external-function-2-arg.ink");
...
fn external_function_zero_arguments() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/external-function-0-arg.ink");
    let mut text: Vec<String> = Vec::new();
...
fn external_function_one_arguments() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/external-function-1-arg.ink");
    let mut text: Vec<String> = Vec::new();
...
fn variable_observers_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/variable-observers.ink");
    let mut text: Vec<String> = Vec::new();
...
fn set_and_get_variable_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/set-get-variables.ink");
    let mut text: Vec<String> = Vec::new();
...
fn jump_knot_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/jump-knot.ink");
    let mut text: Vec<String> = Vec::new();
...
fn jump_stitch_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/jump-stitch.ink");
    let mut text: Vec<String> = Vec::new();
...
fn read_visit_counts_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/read-visit-counts.ink");
    let mut text: Vec<String> = Vec::new();
...
fn load_save_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/runtime/load-save.ink");
    let mut text: Vec<String> = Vec::new();
    ...
    let _ = common::compile_story("inkfiles/runtime/load-save.ink");
