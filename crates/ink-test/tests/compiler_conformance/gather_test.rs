...
fn gather_basic_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/gather/gather-basic.ink");
...
fn gather_chain_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/gather/gather-chain.ink");
    let mut text: Vec<String> = Vec::new();
...
fn nested_flow_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/gather/nested-flow.ink");
    let mut text: Vec<String> = Vec::new();
...
fn deep_nesting_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/gather/deep-nesting.ink");
    let mut text: Vec<String> = Vec::new();
...
fn complex_flow1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/gather/complex-flow.ink");
    let mut text: Vec<String> = Vec::new();
