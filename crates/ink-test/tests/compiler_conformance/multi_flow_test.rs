...
fn basics_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/runtime/multiflow-basics.ink");
...
fn multiflow_save_load_threads() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/runtime/multiflow-saveloadthreads.ink");
