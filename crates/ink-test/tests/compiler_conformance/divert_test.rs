...
fn simple_divert_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/divert/simple-divert.ink");
...
fn invisible_divert_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/divert/invisible-divert.ink");
...
fn divert_on_choice_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/divert/divert-on-choice.ink");
...
fn complex_branching1_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/divert/complex-branching.ink");
    let mut text: Vec<String> = Vec::new();
