...
use crate::compiler_conformance::api::story::Story;

use crate::compiler_conformance::common;

#[test]
fn list_basic_operations_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/basic-operations.ink");
...
fn list_mixed_items_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/list-mixed-items.ink");
...
fn more_list_operations_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/more-list-operations.ink");
...
fn empty_list_origin_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/empty-list-origin.ink");
...
fn list_save_load_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/list-save-load.ink");
...
fn empty_list_origin_after_assinment_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/empty-list-origin-after-assignment.ink");
...
fn list_range_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/list-range.ink");
...
fn list_bug_adding_element_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/bug-adding-element.ink");
...
fn more_list_operations2_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/more-list-operations2.ink");
...
fn list_all_bug_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/list-all.ink");
...
fn list_comparison_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/lists/list-comparison.ink");
