...
fn operations_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/misc/operations.ink");
...
fn read_counts_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/misc/read-counts.ink");
...
fn turns_since_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/misc/turns-since.ink");
...
fn issue15_test() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/misc/issue15.ink");
...
fn newlines_with_string_eval_test() -> Result<(), Box<dyn Error>> {
    let mut story = common::compile_story("inkfiles/misc/newlines_with_string_eval.ink");
...
fn i18n() -> Result<(), StoryError> {
    let mut story = common::compile_story("inkfiles/misc/i18n.ink");
