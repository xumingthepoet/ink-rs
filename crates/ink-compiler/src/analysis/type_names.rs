...
pub(super) fn qualify_type_name_for_module(type_name: &TypeName, module: &str) -> TypeName {
    match type_name {
        ...
        TypeName::Primitive(_) | TypeName::QualifiedStruct(_) | TypeName::Void => type_name.clone(),
    }
}
...
pub(super) fn type_name_module(type_name: &TypeName) -> Option<&str> {
    match type_name {
        ...
        TypeName::Primitive(_) | TypeName::Struct(_) | TypeName::Void | TypeName::Array(_) => None,
    }
}
