...
These don't show up in the main text flow, but can be read off by the game and used as you see fit. See the [Running Your Ink](../ink-csharp/Documentation/RunningYourInk.md#marking-up-your-ink-content-with-tags) guide for more information.
