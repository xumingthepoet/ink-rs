...
- [2026-04-25 00:35 CST] [👍4][👎0] Flow diagnostics belong in compiler analysis over the parsed model. Parse invalid-but-diagnosable C# forms such as function stitches and empty divert statements, preserve spans on nodes such as `Return`, use flow/label indexes for target restrictions and missing direct diverts, but treat declared variables/args as possible variable divert targets.
