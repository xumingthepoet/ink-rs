...
- [2026-04-25 00:35 CST] [👍2][👎0] Flow diagnostics belong in compiler analysis over the parsed model. Parse invalid-but-diagnosable C# forms such as function stitches, preserve spans on nodes such as `Return`, use a flow-symbol index for function/divert target restrictions, and avoid relying on emitted runtime JSON or fixture strings.
