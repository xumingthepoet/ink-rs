...
- [2026-04-24 07:18 CST] [👍6][👎0] Weave lowering needs a current runtime-container model. After gathers, content and choices stay in that gather; inside flows, linear weave objects must carry flow/stitch container paths so conditional rejoin targets become `flow.n`, not root `0.n`.
