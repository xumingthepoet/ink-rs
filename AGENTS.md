...
- [2026-04-25 00:35 CST] [👍7][👎0] Diagnostics belong over parsed-model semantics. Parse invalid-or-warning C# forms such as function stitches, empty divert/thread statements, empty choices, and suspicious text into nodes with spans, then report diagnostics. Focused C# warning tests should assert the intended warning, not just any later analysis warning.
