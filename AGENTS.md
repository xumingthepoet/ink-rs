...
- [2026-04-25 00:35 CST] [👍1][👎0] Flow diagnostics belong in compiler analysis over the parsed model. Preserve source spans on parsed nodes such as `Return`, use a flow-symbol index for function/divert target restrictions, and model branch/sequence termination structurally instead of relying on emitted runtime JSON or fixture strings.
